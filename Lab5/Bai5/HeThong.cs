    ...
    public partial class HeThong : Form
    {
        ...
        private async Task LoadRandomDish(List<Dish> dishList)
        {
            try
            {
                ...
                {
                    Text = "Ăn gì đây ta?",
                    Size = new Size(300, 320)  // Tăng kích thước để chứa thêm nút
                };
                ...
                TableLayoutPanel layout = new TableLayoutPanel
                {
                    ...
                    AutoSize = true,
                    ColumnCount = 1,
                    RowCount = 2, // Cập nhật lại hàng chỉ còn 2
                ...
                // Tạo panel chứa nút Mời bạn bè, đặt nó vào vị trí dưới cùng bên phải
                FlowLayoutPanel buttonPanel = new FlowLayoutPanel
                {
                    FlowDirection = FlowDirection.RightToLeft,  // Đặt các nút từ phải qua trái
                    Dock = DockStyle.Bottom, // Đặt panel này ở dưới cùng
                    Height = 40, // Chiều cao panel để chứa nút
                    Padding = new Padding(10)
                };

                // Tạo nút Mời bạn bè
                Button btnInviteFriends = new Button
                {
                    Text = "Mời bạn bè",
                    Width = 80 // Bạn có thể điều chỉnh chiều rộng nút nếu cần
                };

                // Đăng ký sự kiện cho nút "Mời bạn bè"
                btnInviteFriends.Click += (s, e) =>
                {
                    // Mở form Invite và truyền thông tin món ăn
                    Invite inviteForm = new Invite(
                        randomDish.ten_mon_an,
                        randomDish.gia.ToString(),
                        randomDish.dia_chi,
                        randomDish.nguoi_dong_gop,
                        randomDish.hinh_anh
                    );
                ...
                buttonPanel.Controls.Add(btnInviteFriends);

                // Thêm các điều khiển vào TableLayoutPanel
                layout.Controls.Add(pictureBox, 0, 0);
                layout.Controls.Add(lblDishInfo, 0, 1);

                // Thêm TableLayoutPanel và FlowLayoutPanel vào form
                dishForm.Controls.Add(layout);
                dishForm.Controls.Add(buttonPanel); // Thêm panel chứa nút vào form
